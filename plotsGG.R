...
df3 = data.frame(x=x,
                 y1=dt(x,df=par$dfs[1])*par$sigmas[1]+par$mus[1],
                 y2=dt(x,df=par$dfs[2])*par$sigmas[2]+par$mus[2],
                 y3=dt(x,df=par$dfs[3])*par$sigmas[3]+par$mus[3])
p3 = ggplot(data=df3)+
  geom_line(aes(x=x,y=y3),color=col3,size=1/2)+geom_area(aes(x=x,y=y3),fill=col3,alpha=1/20)+
  ...
  theme(plot.title=element_text(hjust=0.5))+scale_x_continuous(breaks=c(0, 0.01, 0.02, 0.03, 0.04), labels=c("0.0", "2.0", "4.0", "6.0", "8.0")) #+
...
df4 = data.frame(x=x,
                 y1=1/mod$pn$ret.sigma[[1]][1]*dt(x/mod$pn$ret.sigma[[1]][1],df=mod$pn$ret.mu[[1]][1]),
                 y2=1/mod$pn$ret.sigma[[1]][2]*dt(x/mod$pn$ret.sigma[[1]][2],df=mod$pn$ret.mu[[1]][2]))
p7 = ggplot(data=df4)+
...
df5 = data.frame(x=x,
                 y1=1/mod$pn$ret.sigma[[2]][1]*dt(x/mod$pn$ret.sigma[[2]][1],df=mod$pn$ret.mu[[2]][1]),
                 y2=1/mod$pn$ret.sigma[[2]][2]*dt(x/mod$pn$ret.sigma[[2]][2],df=mod$pn$ret.mu[[2]][2]))
p8 = ggplot(data=df5)+
...
df6 = data.frame(x=x,
                 y1=1/mod$pn$ret.sigma[[3]][1]*dt(x/mod$pn$ret.sigma[[3]][1],df=mod$pn$ret.mu[[3]][1]),
                 y2=1/mod$pn$ret.sigma[[3]][2]*dt(x/mod$pn$ret.sigma[[3]][2],df=mod$pn$ret.mu[[3]][2]))
p9 = ggplot(data=df6)+

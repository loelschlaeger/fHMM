...
- `file` is the name of the file where the .csv-file is saved. Per default, it is saved in the current working directory under the name `<symbol>.csv`. If `file = NULL` (default), the data is not saved but returned as a `data.frame`.

...
- The vignette [*State decoding and prediction*](http://loelschlaeger.de/fHMM/articles/v05_state_decoding_prediction.html) introduces the Viterbi algorithm that is used for decoding the most likely underlying state sequence and forecasting. 

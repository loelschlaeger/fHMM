...
#' @param 
#' This function visualizes the data time series. If \code{decoding} is
#' specified, the decoding is highlighted. If \code{events} is specified, 
#' the events are highlighted.
#' @param data 
#' A list of processed data information.
#' @param decoding 
#' A matrix of decoded states.
#' @param colors 
#' An object of class \code{fHMM_colors}. Ignored if \code{decoding = NULL}.
#' @param events 
#' A list of events.
#' @param predict
...
plot_ts = function(data, decoding, colors, events, predict){

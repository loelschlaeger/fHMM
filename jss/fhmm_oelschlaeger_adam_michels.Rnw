...
R-packages: general-purpose: \pkg{deepmixS4} \citep{vis10}, \pkg{msm} \citep{jac11}, ... Special-puropose: animal movement modeling: \pkg{moveHMM} \citep{mic16}, \pkg{momentuHMM} \citep{mcc18}. Hidden semi-Markov models: \pkg{hsmm} \citep{bul10}, \pkg{countHMM} \citep{ada19b}.

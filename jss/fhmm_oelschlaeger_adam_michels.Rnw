...
%
<<dax-ts, fig=TRUE, width = 9, height = 5>>=
events <- fHMM_events(
  list(
...
%
<<sim-data-ts, fig=TRUE, width = 12, height = 6>>=
plot(data_sim)
@
%
...
%
<<dax-sdds-ll, fig=TRUE, width = 12, height = 6>>=
par(mfrow = c(1,2))
...
%
<<hhmm-sdds, fig=TRUE, width = 10, height = 8>>=
...
%
<<dax-dec-ts, fig=TRUE, width = 12, height = 8>>=
plot(dax_model_3t)
@
%

...
R-packages: general-purpose: deepmixS4 \citep{vis10}, ... Special-puropose: animal movement modeling: moveHMM \citep{mic16}, momentuHMM \citep{mcc18}. Hidden semi-Markov models: hsmm \citep{bul10}.

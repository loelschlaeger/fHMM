...
\author{authors}
\Plainauthor{plainauthors}

%% - \title{} in title case
%% - \Plaintitle{} without LaTeX markup (if any)
%% - \Shorttitle{} with LaTeX markup (if any), used as running title
\title{\pkg{fHMM}: Fitting ... in \proglang{R}}
\Plaintitle{fHMM: Fitting ... in R}
\Shorttitle{fHMM}

%% - \Abstract{} almost as usual
\Abstract{
\pkg{fHMM} is an \proglang{R} package for ...
}

%% - \Keywords{} with LaTeX markup, at least one required
%% - \Plainkeywords{} without LaTeX markup (if necessary)
%% - Should be comma-separated and in sentence case.
\Keywords{keywords, \proglang{R}}
\Plainkeywords{plainkeywords, R}
...
\end{Sinput}
\begin{Soutput}
- path: C:\Users\LOELSC~1\AppData\Local\Temp\RtmpcpSCdo
- model id: test
- model type: hmm
- data type: simulated
- number of states: 2
...
\pkg{fHMM}~0.3.0 package. \proglang{R} itself

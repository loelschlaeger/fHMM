...
%% Literature review
Over the last decades, HMMs have been applied to various financial problems, including modeling business cycles (...), deriving stylized facts of stock returns \cite{bul06, nys15a}, and modeling energy prices conditional on market regimes \cite{lan18, ada22}, to name but a few examples.
...
\end{Sinput}
\begin{Soutput}
[1] "C:/Users/Lennart/Documents/R/win-library/4.1/fHMM/extdata/dax.csv"
\end{Soutput}
\begin{Sinput}
R> system.file("extdata", "vw.csv", package = "fHMM")
\end{Sinput}
\begin{Soutput}
[1] "C:/Users/Lennart/Documents/R/win-library/4.1/fHMM/extdata/vw.csv"
\end{Soutput}
\end{Schunk}
%
...
Estimates:
                  lb   estimate        ub
Gamma_2.1  2.790e-03  5.146e-03 9.429e-03
Gamma_3.1         NA  1.500e-69        NA
Gamma_1.2         NA  1.740e-02        NA
Gamma_3.2         NA  2.641e-02        NA
Gamma_1.3         NA  1.972e-64        NA
Gamma_2.3  1.394e-02  2.170e-02 3.357e-02
mu_1      -3.726e-03 -1.674e-03 3.784e-04
mu_2      -7.969e-04 -2.518e-04 2.933e-04
mu_3       9.610e-04  1.269e-03 1.576e-03
sigma_1    2.330e-02  2.563e-02 2.819e-02
sigma_2    1.269e-02  1.324e-02 1.381e-02
sigma_3    5.332e-03  5.774e-03 6.253e-03
df_1       5.501e+00  1.064e+01 2.059e+01
df_2       4.958e+75  4.958e+75 4.958e+75
df_3       3.964e+00  5.272e+00 7.012e+00
...
-3.523766 -0.659750  0.010357 -0.002317  0.673963  3.919070 
\end{Soutput}
\end{Schunk}
%

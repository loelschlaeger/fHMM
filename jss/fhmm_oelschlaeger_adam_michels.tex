...
\Abstract{
\pkg{fHMM} is an \proglang{R} package for modeling financial time series data using hidden Markov models.
}
...
The functionality of the \pkg{fHMM} package can be classified into functions for data preparation, model estimation, and model evaluation, see Figure \ref{fig:flowchart}. The following flowchart visualizes their dependencies:
...
* from: 1987-12-30 
* to: 2022-03-14 
* path: C:\Users\Lennart\Projekte\fHMM\jss\dax.csv
\end{Soutput}
\end{Schunk}
%

...
- If you would like to add extensions to the package, please fork the `master` branch and submit a pull request.
...
The package has a built-in function to download financial data from [Yahoo Finance](https://finance.yahoo.com/):
